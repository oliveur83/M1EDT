  ...
  if ("undefined" == typeof DayPilot.$) {
    "undefined" == typeof DayPilot.Global && (DayPilot.Global = {}),
      ...
      (DayPilot.mo2 = function (e, t) {
        ...
        if (((t = t || window.event), "undefined" != typeof t.offsetX)) {
          ...
          for (var r = t.srcElement; r && r !== e; )
            "SPAN" !== r.tagName &&
              ((a.x += r.offsetLeft),
              r.offsetTop > 0 && (a.y += r.offsetTop - r.scrollTop)),
              (r = r.offsetParent);
          return r ? a : null;
        }
        ...
        for (
          ...
          (e = e.offsetParent),
            ...
            t &&
              ...
              a.y < 0 && ((a.h += a.y), (a.y = 0)),
              e.scrollLeft > 0 &&
                a.x + a.w > e.clientWidth &&
                (a.w -= a.x + a.w - e.clientWidth),
              e.scrollTop &&
                a.y + a.h > e.clientHeight &&
                (a.h -= a.y + a.h - e.clientHeight)),
            (a.x += e.offsetLeft),
            (a.y += e.offsetTop);
          ...
          (a.add = function (a, r, o) {
            return t
              ...
              : void (e.sheet.insertRule
                  ? ("undefined" == typeof o && (o = e.sheet.cssRules.length),
                    e.sheet.insertRule(a + "{" + r + "}", o))
                  : e.sheet.addRule && e.sheet.addRule(a, r, o));
          }),
          a
        );
      }),
      ...
      (DayPilot.rePassive = function (e, t, a) {
        a && e && e.addEventListener(t, a, { passive: !0 });
      }),
      (DayPilot.reNonPassive = function (e, t, a) {
        a && e && e.addEventListener(t, a, { passive: !1 });
      }),
      (DayPilot.pu = function (e) {
        ...
        if (o)
          for (a = o.length, t = 0; t < a; t += 1)
            o[t] &&
              ((r = o[t].name), "function" == typeof e[r] && (e[r] = null));
        if ((o = e.childNodes))
          for (a = o.length, t = 0; t < a; t += 1) {
      ...
      (DayPilot.request = function (e, t, a, r) {
        ...
        o &&
          ...
          (o.onreadystatechange = function () {
            if (4 === o.readyState)
              return 200 !== o.status && 304 !== o.status
                ? void (r
                    ? r(o)
                    : window.console && console.log("HTTP error " + o.status))
                : void t(o);
          }),
          4 !== o.readyState &&
            ("object" == typeof a && (a = JSON.stringify(a)), o.send(a)));
      }),
    ...
    (DayPilot.Date = function (t, a) {
      ...
      var r;
      DayPilot.Util.isNullOrUndefined(t) &&
        ((r = DayPilot.DateUtil.fromLocal().getTime()), (t = r));
      ...
      (DayPilot.Event = function (e, t, a) {
        ...
        (this.isEvent = !0),
          ...
          (this.start = function (e) {
            return "undefined" == typeof e
              ? new DayPilot.Date(r.data.start)
              : void (this.temp().start = new DayPilot.Date(e));
          }),
          (this.end = function (e) {
            return "undefined" == typeof e
              ? new DayPilot.Date(r.data.end)
            ...
            if ("undefined" == typeof e) {
              var t = r.cache || r.data,
                a =
                  r.calendar &&
                  r.calendar.internal &&
                  r.calendar.internal.xssTextHtml;
              return a
                ? a(t.text, t.html)
          ...
          (this.client.header = function (e) {
            return "undefined" == typeof e
              ? r.data.header
              : void (r.data.header = e);
          }),
          (this.client.cssClass = function (e) {
            return "undefined" == typeof e
              ? r.cache && "undefined" != typeof r.cache.cssClass
                ? r.cache.cssClass
                : r.data.cssClass
              : void (r.data.cssClass = e);
          }),
          (this.client.toolTip = function (e) {
            return "undefined" == typeof e
              ? r.cache && "undefined" != typeof r.cache.toolTip
                ? r.cache.toolTip
                : "undefined" != typeof r.data.toolTip
                ? r.data.toolTip
                : r.data.text
              : void (r.data.toolTip = e);
          }),
          (this.client.barVisible = function (e) {
            return "undefined" == typeof e
              ? r.cache && "undefined" != typeof r.cache.barHidden
                ? !r.cache.barHidden
                : r.calendar.durationBarVisible && !r.data.barHidden
              : void (r.data.barHidden = !e);
          }),
          ...
          (this.client.moveEnabled = function (e) {
            return "undefined" == typeof e
              ? r.cache && "undefined" != typeof r.cache.moveDisabled
                ? !r.cache.moveDisabled
                : "Disabled" !== r.calendar.eventMoveHandling &&
                  !r.data.moveDisabled
              : void (r.data.moveDisabled = !e);
          }),
          (this.client.resizeEnabled = function (e) {
            return "undefined" == typeof e
              ? r.cache && "undefined" != typeof r.cache.resizeDisabled
                ? !r.cache.resizeDisabled
                : "Disabled" !== r.calendar.eventResizeHandling &&
                  !r.data.resizeDisabled
              : void (r.data.resizeDisabled = !e);
          }),
          (this.client.clickEnabled = function (e) {
            return "undefined" == typeof e
              ? r.cache && "undefined" != typeof r.cache.clickDisabled
                ? !r.cache.clickDisabled
                : "Disabled" !== r.calendar.eventClickHandling &&
                  !r.data.clickDisabled
              : void (r.data.clickDisabled = !e);
          }),
          (this.client.rightClickEnabled = function (e) {
            return "undefined" == typeof e
              ? r.cache && "undefined" != typeof r.cache.rightClickDisabled
                ? !r.cache.rightClickDisabled
                : "Disabled" !== r.calendar.eventRightClickHandling &&
                  !r.data.rightClickDisabled
              : void (r.data.rightClickDisabled = !e);
          }),
          (this.client.deleteEnabled = function (e) {
            return "undefined" == typeof e
              ? r.cache && "undefined" != typeof r.cache.deleteDisabled
                ? !r.cache.deleteDisabled
                : "Disabled" !== r.calendar.eventDeleteHandling &&
                  !r.data.deleteDisabled
              : void (r.data.deleteDisabled = !e);
          }),
          (this.toJSON = function (e) {
            var t = {};
            if (
              ...
              (t.end = this.end()),
              (t.tag = {}),
              r.calendar && r.calendar.tagFields)
            )
  ...
  (function () {
    ...
    function a(e, i) {
      var d,
        ...
        m = i[e];
      switch (
        (m && "object" == typeof m && "function" == typeof m.toJSON2
          ? (m = m.toJSON2(e))
          : m &&
            "object" == typeof m &&
        ...
        case "object":
          ...
          if (
            ((r += o),
            (c = []),
            "number" == typeof m.length && !m.propertyIsEnumerable("length"))
          ) {
          ...
          if (n && "object" == typeof n)
            for (u = n.length, d = 0; d < u; d += 1)
              (l = n[d]),
                "string" == typeof l &&
                  ((s = a(l, m)), s && c.push(t(l) + (r ? ": " : ":") + s));
          else
            for (l in m)
              Object.hasOwnProperty.call(m, l) &&
                ((s = a(l, m)), s && c.push(t(l) + (r ? ": " : ":") + s));
          return (
            (s =
              0 === c.length
    ...
    if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
      ...
      (t.selectedCells = []),
        ...
        (t.getCellsAbove = function (e) {
          for (
            var i = [], n = t.getColumn(e), s = e.parentNode, a = null;
            s && a !== t.firstSelected;

          )
            for (
              a = s.getElementsByTagName("td")[n],
                i.push(a),
                s = s.previousSibling;
              s && "TR" !== s.tagName;
        ...
        (t.getCellsBelow = function (e) {
          for (
            ...
            for (
              a = s.getElementsByTagName("td")[n], i.push(a), s = s.nextSibling;
              s && "TR" !== s.tagName;
        ...
        (t.gMouseUp = function (i) {
          if (t.resizing) {
            ...
            if (!t.movingShadow)
              return (
                (t.moving = null), void (document.body.style.cursor = "default")
              );
            ...
            t.deleteShadow(t.movingShadow),
              DayPilot.Util.removeClass(
                t.moving,
                n.calendar.b("_event_moving_source")
              );
            ...
            r.d(h.start, h.end, h.resource),
              "Hold" !== r.timeRangeSelectedHandling &&
        ...
        (t.Calendar = function (e, i) {
          var n = !1;
          if (
            (this instanceof t.Calendar && !this.f && ((n = !0), (this.f = !0)),
            !n)
          )
          ...
          (this.uniqueID = null),
            ...
            (this.k = function (e, t, i) {
              ...
              var a = "JSON" + DayPilot.JSON.stringify(n);
              this.backendUrl
                ? DayPilot.request(this.backendUrl, this.l, a, this.ajaxError)
          ...
          (this.m = function (e, t) {
            ...
            (this.H = function () {
              ...
              return (
                (e =
                  "BusinessHoursNoScroll" === this.heightSpec ? this.I() : 24),
                60 * e * 60 * 1e3
              );
            }),
            (this.K = function () {
            ...
            (this.O = function (e) {
              ...
              if (
                ...
                "function" == typeof s.onEventRightClick &&
                  (s.onEventRightClick(i), i.preventDefault.value))
              )
                return !1;
              switch (s.eventRightClickHandling) {
                case "ContextMenu":
                  ...
                  n
                    ? n.show(t)
                    : s.contextMenu && s.contextMenu.show(this.event);
              }
              return (
                "function" == typeof s.onEventRightClicked &&
                  s.onEventRightClicked(i),
            ...
            (this.c = function (e, t, i, n) {
              ...
              r instanceof DayPilot.Date && (r = r.toDate()),
                c.setTime(
                  Date.UTC(r.getUTCFullYear(), r.getUTCMonth(), r.getUTCDate())
                );
              var d =
                  r.getTime() -
                  (c.getTime() +
                    3600 * r.getUTCHours() * 1e3 +
                    30 * Math.floor(r.getUTCMinutes() / 30) * 60 * 1e3),
              ...
              if (!t.selecting && "Disabled" !== s.timeRangeSelectedHandling) {
                ...
                if (1 === i || 0 === i)
                  return (
                    ...
                    t.selectedCells &&
                      (s.clearSelection(), (t.selectedCells = [])),
            ...
            (this.U = function (e) {
              if (e < 0) return null;
              for (
                var t = 0, i = s.nav.events.rows[0].cells, n = 0;
                n < i.length;
                n++
              ) {
            ...
            (this.columns.load = function (e, t, i) {
              ...
              s.columnsLoadMethod &&
              "POST" === s.columnsLoadMethod.toUpperCase()
                ? DayPilot.ajax({
                    method: "POST",
                    url: e,
                    success: a,
            ...
            (this.Y = function (e) {
              ...
              return (
                ...
                e.start
                  ...
                  : (t.start = new DayPilot.Date(s.startDate)),
                  ...
                  return (
                    (i.isFree = function (e, t) {
                      for (
                        ...
                        if (
                          !(
                            i < a.part.top || e > a.part.top + a.part.height - 1
                          )
                        )
                          return !1;
                      }
            ...
            (this.X = function () {
              ...
              for (var n = 0; n < i; n++) {
                var l = s.headerDateFormat
                    ? s.headerDateFormat
                    : a.locale().datePattern,
                  o = {};
                (o.start = t.addDays(n)),
                ...
                (a.onmousedown = function (i) {
                  ...
                  if (
                    ...
                    (t.resizing = this),
                      ...
                      (t.originalTop = this.offsetTop),
                      (s.nav.top.style.cursor = this.style.cursor);
                  return !1;
                });
              var l = document.createElement("div");
              if (
                (l.setAttribute("unselectable", "on"),
                (l.className = s.b("_event_inner")),
                (l.innerHTML = e.client.html()),
                "darker" === i.borderColor && i.backColor
                  ? (l.style.borderColor = DayPilot.ColorUtil.darker(
                      i.backColor,
                      2
                    ))
                  : (l.style.borderColor = i.borderColor),
                i.backColor &&
                  ((l.style.background = i.backColor),
            ...
            (this.fa = function () {
              ...
              (e.style.top = "0px"),
                ...
                (this.nav.events = e);
              for (
                var t = this.Q, i = t.length, n = e.insertRow(-1), a = 0;
                a < i;
                a++
              ) {
            ...
            (this.C = function () {
              ...
              this.tableCreated = !0;
              for (
                var l = a.length, o = this.nav.events;
                o && o.rows && o.rows.length > 0;
              ...
              for (var v = 0; v < n; v++) {
                ...
                for (var h = 0; h < l; h++) {
                  ...
                  this.ja(c.start, c.end) &&
                    DayPilot.Util.addClass(d, s.b("_cell_business"));
              ...
              (e.root = this),
                (s.nav.scrollable.onmousemove = function (e) {
                  ...
                  if (t.resizing) {
                    t.resizingShadow ||
                      (t.resizingShadow = s.r(t.resizing, !1, s.shadow));
                    var a = s.cellHeight,
                      l = 1,
                    ...
                    if ("bottom" === t.resizing.dpBorder) {
                      var r =
                        Math.floor(
                          (t.originalHeight + t.originalTop + o + a / 2) / a
                        ) *
                          a -
                        t.originalTop +
                        l;
                      ...
                      var c =
                        Math.floor((t.originalTop + o - l + a / 2) / a) * a + l;
                      c < l && (c = l),
                        c > t.originalTop + t.originalHeight - a &&
                          (c = t.originalTop + t.originalHeight - a);
                    ...
                    if (
                      (t.movingShadow ||
                        ((t.movingShadow = s.r(t.moving, !s.h, s.shadow)),
                    ...
                    d || (d = a / 2);
                    var c =
                      Math.floor((s.coords.y - d - l + a / 2) / a) * a + l;
                    c < l && (c = l);
                    var u = s.nav.events,
                    ...
                    f < 0 && (f = 0),
                      f < u.rows[0].cells.length &&
                        f >= 0 &&
                        t.movingShadow.column !== f &&
                        ((t.movingShadow.column = f),
                        t.moveShadow(u.rows[0].cells[f]));
                  } else if (t.selecting) {
                    var n = DayPilot.mc(e),
                      g = s.V.getCellCoords(),
                      m = t.column,
                    ...
                    n.y < t.firstMousePos.y
                      ? ((t.selectedCells = t.getCellsBelow(y)),
                        (t.topSelectedCell = t.selectedCells[0]),
                        (t.bottomSelectedCell = t.firstSelected))
                      : ((t.selectedCells = t.getCellsAbove(y)),
                        (t.topSelectedCell = t.firstSelected),
                        (t.bottomSelectedCell = t.selectedCells[0])),
                      s.S();
                  }
            ...
            (this.la = function (e) {
              if ("Disabled" !== s.headerClickHandling) {
                ...
                (n.header = {}),
                  ...
                  ("function" == typeof s.onHeaderClick &&
                    (s.onHeaderClick(n), n.preventDefault.value)) ||
                    ("function" == typeof s.onHeaderClicked &&
                      s.onHeaderClicked(n));
              }
            }),
            (this.na = function (e) {
            ...
            (this.pa = function () {
              ...
              var t =
                "undefined" != typeof this.ra.scrollpos
                  ? this.ra.scrollpos
                  : this.initScrollPos;
              t &&
                ("Auto" === t &&
            ...
            (this.events.load = function (e, t, i) {
              ...
              if (
                s.eventsLoadMethod &&
                "POST" === s.eventsLoadMethod.toUpperCase()
              )
                DayPilot.Http.ajax({
                  method: "POST",
                  data: {
                ...
                var l = e,
                  o =
                    "start=" +
                    s.visibleStart().toString() +
                    "&end=" +
                    s.visibleEnd().toString();
                (l += l.indexOf("?") > -1 ? "&" + o : "?" + o),
                  DayPilot.Http.ajax({
                    method: "GET",
                    url: l,
            ...
            (this.ua = function () {
              if (s.nav.top.className !== s.b("_main")) {
                ...
                t &&
                  ((t.className = s.b("_cornerright")),
                  (t.firstChild.className = s.b("_cornerright_inner")));
              }
            }),
            ...
            (this.z = function () {
              ...
              if (((s.Ba.events = []), e)) {
                ...
                for (var a = 0; a < this.Q.length; a++) {
                  ...
                  for (
                    var h = new DayPilot.Date(r.start),
                      c = h.getTime(),
                      d = h.addTime(i),
                      u = d.getTime(),
                      v = 0;
                    ...
                    if (!n[v]) {
                      ...
                      if (!(m < g)) {
                        ...
                        if (
                          ...
                          var k = w.boxBottom;
                          (b.part.top =
                            Math.floor(D / this.cellHeight) * this.cellHeight +
                            1),
                            (b.part.height =
                              Math.max(
                                Math.ceil(k / this.cellHeight) *
                                  this.cellHeight -
                                  b.part.top,
                                this.cellHeight - 1
                              ) + 1),
                          ...
                          p > o.maxStart && (o.maxStart = p),
                            ...
                            "function" == typeof this.onBeforeEventRender &&
                              (b.cache = this.Ba.events[v]),
                            b.part.start.getTime() === g &&
                              b.part.end.getTime() === m &&
                              (n[v] = !0);
                        }
                      }
                    }
            ...
            (this.xa = function () {
              var e = 0;
              s.ra.scrollHour
                ? (e = 2 * s.cellHeight * s.ra.scrollHour)
                : "Auto" === s.initScrollPos &&
                  (e =
                    "BusinessHours" === this.heightSpec
                      ? 2 * this.cellHeight * this.businessBeginsHour
                      : 0),
            ...
            (this.Fa = function () {
              return (
                ...
                ("undefined" == typeof s.events.list || !s.events.list)
              );
            }),
            (this.u = function () {
      ...
      (this.onShow = null),
        ...
        (this.prepare = function () {
          if (
            ...
            (this.resetTarget = !0),
            (this.pattern = this.a.locale().datePattern),
        ...
        (this.b = function () {
          ...
          if (((e = "INPUT" === t.tagName ? t.value : t.innerText), !e))
            return null;
          for (
            var n = DayPilot.Date.parse(e, i.pattern), a = 0;
            a < i.patterns.length;
            a++
          ) {
            if (n) return n;
              ...
              (n.onTimeRangeSelected = function (t) {
                ...
                (t.start = e),
                  ...
                  ("function" == typeof i.onTimeRangeSelect &&
                    (i.onTimeRangeSelect(t), t.preventDefault.value)) ||
                    (i.c(a),
                    i.close(),
                    "function" == typeof i.onTimeRangeSelected &&
                      i.onTimeRangeSelected(t));
              }),
              (this.navigator = n);
      ...
      (t.mouse = null),
        ...
        (DayPilot.Menu = function (n) {
          ...
          (this.v = "2022.3.432-lite"),
            ...
            (this.show = function (n, u) {
              ...
              if (
                ...
                for (var d = 0; d < this.items.length; d++) {
                  ...
                  if (
                    (DayPilot.Util.addClass(f, this.c("item")),
                    m.items &&
                      (DayPilot.Util.addClass(f, this.c("item_haschildren")),
                      DayPilot.Util.addClass(c, this.c("withchildren"))),
                    "undefined" != typeof m && !m.hidden)
                  ) {
                    if ("-" === m.text) {
                      var h = document.createElement("div");
                      ...
                      if (
                        ...
                        m.cssClass && DayPilot.Util.addClass(v, m.cssClass),
                        m.disabled)
                      )
                        ...
                        if (m.onclick) e();
                          ...
                          (v.href = m.href.replace(/\x7B0\x7D/gim, a)),
                            m.target && v.setAttribute("target", m.target);
                        else if (m.command) {
                          var b = function (e, t) {
                            return function (n) {
                              var i = t.source,
                              ...
                              if (i instanceof DayPilot.Link)
                                return void u.internal.linkMenuClick(
                                  o.command,
                                  i,
                                  o.action
                                );
                              if (i instanceof DayPilot.Selection)
                                return void u.internal.timeRangeMenuClick(
                                  o.command,
                                  i,
                                  o.action
                                );
                              if (i instanceof DayPilot.Event)
                                return void u.internal.eventMenuClick(
                                  o.command,
                                  i,
                                  o.action
                                );
                              ...
                              if (i instanceof DayPilot.Task)
                                return void ("resource" === i.menuType
                                  ? u.internal.resourceHeaderMenuClick(
                                      o.command,
                                      t.menuSource,
                                      o.action
                                    )
                                  : u.internal.eventMenuClick(
                                      o.command,
                                      t.menuSource,
                                      o.action
                                    ));
                              switch (i.menuType) {
                                case "resource":
                                  return void u.internal.resourceHeaderMenuClick(
                                    o.command,
                                    i,
                                    o.action
                                  );
                ...
                if (
                  ...
                  var _ = u.parentLink,
                    L = parseInt(
                      new DayPilot.StyleReader(c).get("border-top-width")
                    ),
            ...
            (this.cloneOptions = function () {
              return DayPilot.Util.copyProps(u, {}, [
                "cssClassPrefix",
                "theme",
                "hideAfter",
                "hideOnMouseOut",
            ...
            (this.hide = function (e) {
              ...
              if (
                ...
                o && (DayPilot.de(o), (o = null)),
                (i.b.visible = !1),
                (i.b.source = null),
                i.f && e.hideParent && i.f.hide(e),
          ...
          if (u) for (var a in u) this[a] = u[a];
        }),
        ...
        (DayPilot.MenuBar.deactivate = function () {
          DayPilot.MenuBar.active &&
            (DayPilot.MenuBar.active.l(), (DayPilot.MenuBar.active = null));
        }),
  ...
  (function (DayPilot) {
    ...
    if (!DayPilot.ModalStatic) {
          ...
          (this.id = "_" + new Date().getTime() + "n" + 10 * Math.random()),
            ...
            (this.showUrl = function (e) {
              ...
              if (this.useIframe) {
                ...
                a &&
                  ...
                  this.setInnerHTML(this.id + "iframe", a)),
            ...
            (this.e = function () {
              ...
              var e = window,
                ...
                i = e.pageYOffset
                  ? e.pageYOffset
                  : a.documentElement && a.documentElement.scrollTop
                ...
                for (
                  ...
                  (this.div.style.width = n + "px"),
                    (this.div.style.marginLeft =
                      "-" + Math.floor(n / 2) + "px");
                for (
                  var o = this.maxHeight || e() - 2 * this.top, l = this.height;
                  l < o && this.n();
                  l += 10
                )
                  (this.iframe.style.height = l + "px"),
                    (this.div.style.height = l + "px");
                this.autoStretchFirstLoadOnly &&
                  this.ue(this.iframe, "load", this.h);
            ...
            (this.f = function () {
              this.a ||
                (this.re(window, "resize", this.o),
                this.re(window, "scroll", this.p),
                this.dragDrop &&
                  (this.re(document, "mousemove", this.q),
                  this.re(document, "mouseup", this.r)),
                (this.a = !0));
            }),
            (this.s = function () {
              this.ue(window, "resize", this.o),
                ...
                this.dragDrop &&
                  (this.ue(document, "mousemove", this.q),
                  this.ue(document, "mouseup", this.r)),
                (this.a = !1);
            }),
            (this.t = function (e) {
              e.target === t.div &&
                ...
                t.u(),
                (t.c = t.mc(e || window.event)),
                (t.b = { x: t.div.offsetLeft, y: t.div.offsetTop }));
            }),
            (this.q = function (e) {
              if (t.c) {
            ...
            (this.setInnerHTML = function (e, a) {
              ...
              n.document && (n = n.document),
                ...
                t.autoStretch &&
                  ((t.autoStretchFirstLoadOnly && t.A) ||
                    (t.stretch(), (t.A = !0)));
            }),
            ...
            (this.hide = function (e) {
              ...
              (a.backgroundClick = !!e.backgroundClick),
                ...
                ("function" == typeof this.onClose &&
                  (this.onClose(a), a.preventDefault.value)) ||
                  (this.div &&
      ...
      (l.prototype.create = function () {
            ...
            a = {
              ...
              date: function () {
                ...
                a.apply = function (e) {
                  ...
                  var l = new DayPilot.Date(e.value).toString(
        ...
        (l.prototype.K = function (e) {
          ...
          for (
            var o = 60 / n,
              ...
              d = DayPilot.Locale.find(l) || DayPilot.Locale.US,
        ...
        (l.prototype.L = function (e) {
          ...
          a.apply = function (e) {
            ...
            var s = new DayPilot.Date(e.value).toString(
              e.data.dateFormat || l.pattern,
              l.locale
            );
            o.value = s;
          };
        ...
        (l.prototype.findViewById = function (e, t) {
          return this.G.find(function (a) {
            return (
              a.row.field === e &&
              ("radio" !== a.row.type || a.row.resolved === t)
            );
          });
        }),
      ...
      (s.prototype.select = function (e) {
        return (
          (this.O = this.data.find(function (t) {
            return t.id === e;
          })),
          this.W(!1),
          this
        ...
        (s.prototype.create = function () {
          ...
          function t(e) {
            ...
            var t = !e.dontScroll;
            document
              .querySelectorAll("." + r.theme + "_list_item_highlight")
              .forEach(function (e) {
                e.className = e.className.replace(
                  r.theme + "_list_item_highlight",
                  ""
                );
              }),
              r.P &&
                ((r.P.className += " " + r.theme + "_list_item_highlight"),
                t && !a(r.P, m) && r.P.scrollIntoView());
          }
          function a(e, t) {
          ...
          return (
            ...
            (this.S = m),
            this.O ||
              ((this.O = this.data[0]), this.O && (p.value = this.O.name)),
            c.appendChild(p),
            c.appendChild(u),
            c.appendChild(h),
            c.appendChild(m),
        ...
        (s.prototype.V = function () {
          this.X(),
            this.O
              ? (this.R.value = this.O.name)
              : ((this.R.value = ""), this.W(!0));
        }),
        ...
        (s.prototype.W = function (e) {
          if (
            ((this.U.value = this.selected ? this.selected.id : null),
            this.O ? (this.R.value = this.O.name) : (this.R.value = ""),
    ...
    if ("undefined" == typeof DayPilot.Month || !DayPilot.Month.events) {
      ...
      (t.Month = function (e, i) {
        ...
        (this.id = e),
            ...
            return t.CallBackRedirect
              ...
              : ((n.events.list = t.Events),
                "Full" === t.UpdateType &&
                  ...
                  (n.timeFormat = t.TimeFormat ? t.TimeFormat : n.timeFormat),
                  "undefined" != typeof t.WeekStarts &&
                    (n.weekStarts = t.WeekStarts),
                  (n.hashes = t.Hashes)),
                n.b(),
                n.c(),
                n.d(),
          ...
          (this.s = function () {
            ...
            for (var t = 0; t < this.rows.length; t++)
              for (var e = this.rows[t], i = 0; i < e.lines.length; i++)
                for (var n = e.lines[i], s = 0; s < n.length; s++) this.t(n[s]);
          }),
          (this.r = function (t, e) {
          ...
          (this.t = function (e) {
            ...
            d.setAttribute("unselectable", "on"),
              ...
              e.part.startsHere ||
                DayPilot.Util.addClass(d, this.u("_event_continueleft")),
              e.part.endsHere ||
                DayPilot.Util.addClass(d, this.u("_event_continueright")),
              (d.event = e),
              (d.style.width = h + "%"),
              ...
              (d.onmousemove = function (i) {
                if (
                  ...
                  if (n) {
                    ...
                    var s = 6;
                    n.x <= s && e.client.resizeEnabled()
                      ? e.part.startsHere
                        ? ((d.style.cursor = "w-resize"), (d.dpBorder = "left"))
                        : (d.style.cursor = "not-allowed")
                      : d.clientWidth - n.x <= s && e.client.resizeEnabled()
                      ? e.part.endsHere
            ...
            if (
              ...
              "darker" === i.borderColor && i.backColor
                ...
                : (v.style.borderColor = i.borderColor),
              i.backColor &&
                ((v.style.background = i.backColor),
                (DayPilot.browser.ie9 || DayPilot.browser.ielt9) &&
                  (v.style.filter = "")),
            ...
            for (var s = 0; s < t; s++) {
              ...
              (a.start = this.firstDate.addDays(7 * s)),
                ...
                (a.belongsHere = function (t) {
                  return (
                    (t.end().getTime() === t.start().getTime() &&
                      t.start().getTime() === this.start.getTime()) ||
                    !(
                      t.end().getTime() <= this.start.getTime() ||
                      t.start().getTime() >= this.end.getTime()
                    )
                  );
                }),
                  ...
                  return (
                    (l.isFree = function (t, e) {
                      for (var i = !0, n = 0; n < this.length; n++)
                        t + e - 1 < this[n].part.colStart ||
                          t >
                            this[n].part.colStart + this[n].part.colWidth - 1 ||
                          (i = !1);
                      return i;
                    }),
                    (l.addEvent = function (t, e, i, n, a) {
                      (t.part.colStart = e),
                        ...
                        (t.part.line = a),
                        (t.part.startsHere =
                          s.start.getTime() <= t.start().getTime()),
                        (t.part.endsHere =
                          s.end.getTime() >= t.end().getTime()),
                        this.push(t);
                    }),
                ...
                (a.getHeight = function () {
                  return Math.max(
                    this.lines.length * n.lineHeight() + n.cellHeaderHeight,
            ...
            (this.nav.events = s),
              ...
              (e.onmousemove = function (e) {
                if (t.resizingEvent) {
                  ...
                  a < 1 && (a = 1);
                  var f = v < u ? l : s;
                  (t.timeRangeSelecting.from = { x: f.x, y: f.y }),
          ...
          (this.h = function () {
            ...
            for (var t = 0; t < this.cells.length; t++)
              for (var e = 0; e < this.cells[t].length; e++)
                (this.cells[t][e].style.top = this.getRowTop(e) + "px"),
                  (this.cells[t][e].style.height =
                    this.rows[e].getHeight() + "px");
          }),
          (this.getCellBelowPoint = function (t, e) {
            for (
              var i = Math.floor(this.nav.top.clientWidth / this.getColCount()),
                n = Math.min(Math.floor(t / i), this.getColCount() - 1),
                s = null,
                a = this.headerHeight,
                l = 0,
                o = 0;
          ...
          (this.getCellFromDate = function (t) {
            for (
              var e = DayPilot.DateUtil.daysDiff(this.firstDate, t),
                i = { x: 0, y: 0 };
              e >= 7;
          ...
          (this.C = function (e, i, a) {
            ...
            c.setAttribute("unselectable", "on"),
              ...
              (r.onmousedown = function (s) {
                "Disabled" !== n.timeRangeSelectedHandling &&
                  (n.clearShadow(),
              ...
              (d.onclick = function (t) {
                if ("Enabled" === n.cellHeaderClickHandling) {
                  ...
                  (e.control = n),
                    ...
                    ("function" == typeof n.onCellHeaderClick &&
                      (n.onCellHeaderClick(e), e.preventDefault.value)) ||
                      ("function" == typeof n.onCellHeaderClicked &&
                        n.onCellHeaderClicked(e));
                }
              });
            var v = o.getDay();
            1 === v
              ? (d.innerHTML = s.locale().monthNames[o.getMonth()] + " " + v)
              : (d.innerHTML = v),
              c.appendChild(d),
              (this.cells[e][i] = r),
              a.appendChild(r);
          ...
          (this.F = function (t, e, i) {
            ...
            this.backendUrl &&
              DayPilot.request(this.backendUrl, this.H, s, this.ajaxError);
          }),
          (this.H = function (t) {
            n.a(t.responseText);
          }),
          ...
          (this.I = function (t) {
            ...
            if (
              ...
              "function" != typeof n.onEventRightClick ||
                (n.onEventRightClick(e), !e.preventDefault.value))
            ) {
        ...
        (this.debug = function (t, e) {
          ...
          (this.R = function (t, e) {
            return n.M.N()
              ? DayPilot.Util.escapeTextHtml(t, e)
              : DayPilot.Util.isNullOrUndefined(e)
              ? DayPilot.Util.isNullOrUndefined(t)
                ? ""
                : t
    ...
    if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.nav) {
      (DayPilot.Navigator = function (t, e) {
        ...
        (this.id = t),
            ...
            (this.root.dp = this),
              ...
              "Horizontal" === this.orientation
                ? ((this.root.style.width =
                    this.showMonths * (7 * a.cellWidth() + this.d()) + "px"),
          ...
          (this.i = function (t, e) {
            ...
            (D.style.position = "absolute"),
              ...
              (D.innerHTML =
                a.locale().monthNames[n.getMonth()] + " " + n.getYear()),
              v.appendChild(D),
              (this.ti = D);
            ...
            if (this.showWeekNumbers)
              for (var k = 0; k < u; k++) {
                ...
                switch (this.weekNumberAlgorithm) {
                  case "Auto":
                    C =
                      1 === a.weekStarts() ? S.weekNumberISO() : S.weekNumber();
                    break;
                  case "US":
                    C = S.weekNumber();
                    break;
            ...
            for (var M = 0; M < 7; M++) {
              ...
              for (var k = 0; k < u; k++) {
                ...
                if (
                  (this.cells &&
                    this.cells[S.toStringSortable()] &&
                    (U = this.cells[S.toStringSortable()]),
                  ...
                  (I.cell = U || {}),
                    ...
                    (I.cell.isWeekend =
                      0 === S.dayOfWeek() || 6 === S.dayOfWeek()),
                    U
                      ? ((I.cell.html = U.html || S.getDay()),
                        (I.cell.cssClass = U.css))
                      : ((I.cell.html = S.getDay()), (I.cell.cssClass = null)),
                    i.onBeforeCellRender(I),
                    (U = I.cell);
                }
                if (
                  (U && DayPilot.Util.addClass(R, U.cssClass || U.css),
                  E || (l && N) || (o && W))
                ) {
                  var L = document.createElement("div");
              ...
              for (var t = 0; t < this.showMonths; t++)
                for (var e = 0; e < 7; e++)
                  for (var i = 0; i < 6; i++) {
                    ...
                    s &&
                      (1 === this.items[s.day.toStringSortable()]
                        ? (this.g(s, "busy"), this.h(s, "free"))
                        : (this.h(s, "busy"), this.g(s, "free")));
                  }
          }),
          (this.t = function () {
            var t = {};
          ...
          (this.select = function (t, e, s) {
            ...
            var r = !0,
              c = !0;
            "object" == typeof h
              ? (h.dontFocus && (r = !1), h.dontNotify && (c = !1))
              : "boolean" == typeof h && (r = !h);
            ...
            if (r) {
              ...
              (this.selectionStart < this.A() ||
                this.selectionStart >= this.B()) &&
                (y = this.selectionStart.firstDayOfMonth()),
                y.toStringSortable() !== this.startDate.toStringSortable() &&
                  (f = !0),
                (this.startDate = y);
            }
            o && i.freeHandSelectionEnabled
              ? (i.selectionEnd = new DayPilot.Date(o))
              : this.u(),
              this.f(),
              this.b(),
              this.C(),
              ...
              this.t(),
              !c ||
                (d.equals(this.selectionStart) &&
                  u.equals(this.selectionEnd)) ||
                this.D(),
              f && this.E();
          }),
          (this.update = function (t) {
            if ((i.F(t), this.z)) {
              ...
              i.I(),
                (e.start === i.selectionStart &&
                  e.end == i.selectionEnd &&
                  e.day === i.selectionDay) ||
                  i.D();
            }
          }),
          (this.I = function () {
          ...
          (this.M = function (t, e, i) {
            ...
            this.backendUrl
              ? DayPilot.request(this.backendUrl, this.O, n, this.P)
              : WebForm_DoCallback(
                  this.uniqueID,
                  n,
                  this.Q,
          ...
          (this.m = function (t) {
            return (
              ...
              this.selectionStart.getTime() <= t.getTime() &&
              t.getTime() <= this.selectionEnd.getTime()
            );
          }),
          (this.T = function (t) {
          ...
          (this.is = function (t) {
            ...
            (this.next = function () {
              ...
              return t.y < e.rowCount - 1
                ? { month: t.month, x: 0, y: t.y + 1 }
                : t.month < i.months.length - 1
                ? { month: t.month + 1, x: 0, y: 0 }
                : null;
            }),
            (this.visible = function () {
              ...
              return (
                !!t.isCurrentMonth ||
                !(!t.isPrevMonth || !t.showBefore) ||
                !(!t.isNextMonth || !t.showAfter)
              );
            }),
              ...
              case "week":
                if (i.autoFocusOnClick) {
                  var o = s.cells[0][a].day,
                    r = s.cells[6][a].day;
                  if (
                    o.firstDayOfMonth() === r.firstDayOfMonth() &&
                    (o < i.A() || r >= i.B())
                  )
              ...
              case "month":
                ...
                for (var o = null, r = null, a = 0; a < 6; a++)
                  for (var n = 0; n < 7; n++) {
                    var h = s.cells[n][a];
                    h &&
                      h.day.getYear() === l.getYear() &&
                      h.day.getMonth() === l.getMonth() &&
                      (i.q(e, n, a),
                      i.selected.push(h),
                      null === o && (o = h.day),
                      (r = h.day));
          ...
          (this.D = function (t) {
            ...
            if (((t = t || {}), i.e())) {
              ...
              if (
                ...
                "function" == typeof i.onTimeRangeSelect &&
                  (i.onTimeRangeSelect(l), l.preventDefault.value))
              )
                return;
            ...
            if (i.e()) {
              ...
              if (
                ...
                "function" == typeof i.onVisibleRangeChange &&
                  (i.onVisibleRangeChange(s), s.preventDefault.value))
              )
                return;
        ...
        (a.locale = function () {
          ...
          (this.da = function (t) {
            for (
              var e = new DayPilot.Date(t.start),
