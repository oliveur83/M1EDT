...
*/
        ...
        this._drawEvent = function(e) {
            ...
            * fontColor
            ...
            inner.innerHTML = (e.cache.text+"<br> salle :"+e.cache.id_salle+"<br> professeur :"+e.cache.id_user);
            console.log(e.cache.id)
...
/*            var col = calendar._columnsBottom[e.part.dayIndex];
        ...
        this.events.update = function(e) {
            ...
            var cle = e.cache.id;
            var salle = e.cache.identifiant_salle;
            var groupe = e.cache.groupe;
            var id_user = e.cache.identifiant_user;
            window.location.href = "emploi_du_temps?id=-1&salle=" + salle+  "&code_groupe=" + groupe +"&code_user=" + id_user +"&start=" + start+ "&end=" + end + "&cle=" + cle
